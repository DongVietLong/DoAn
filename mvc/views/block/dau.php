...
<head>
    ...
    <base href="http://localhost:81/LiveServer/">
        ...
        <ul class="navbar-nav bg-gradient-nam sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-icon">
                    <img src="public/img/logo-dai-hoc-cong-nghiep-ha-noi-inkythuatso-01-21-16-44-16.jpg" alt="logo trường đại học sư phạm kỹ thuật vĩnh long" id="logo_truong">
                </div>
                <div class="sidebar-brand-text mx-3">Thư Viện HAUI - 2023</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">haui:</h6>
                        <a class="collapse-item" href="http://haui.edu.vn/vi/" target="_blank">Trang chủ</a>
                        <a class="collapse-item" href="https://lic.haui.edu.vn/vn/html/thong-tin-chung">Giới thiệu</a>
                    </div>
                </div>
            </li>
